...
export const authorizationController = {
  ...
  async get(request, response, next) {
    try {
      ...
      // requests — indieauth.com, which signs people in to the IndieWeb wiki,
      // still does — so a missing value is treated as `id` rather than
      // rejected. Nothing downstream branches on it: whether an access token
      // is issued depends on the requested scope.
